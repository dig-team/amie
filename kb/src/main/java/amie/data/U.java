...
public class U {
	...
	/**
	 * It enumerates all the subsets of indexes of size 'n' for a collection of
	 * items of size
	 * 'collectionSize'.
	 * 
	...
	/**
	 * Recursively enumerates all the subsets of indexes of size 'n' for a
	 * collection of items of size
	 * 'collectionSize'.
	 * 
	 * @param collectionSize
	 * @param n
	...
	/**
	 * Enumerates all the subsets of indexes up to size 'n' for a collection of
	 * items of size
	 * 'collectionSize'.
	 * 
	 * @param collectionSize
	...
	/**
	 * Returns a KB with the content of all the files referenced in the string
	 * array.
	 * 
	 * @param args
	 * @param delimiter
	...
	/**
	 * It returns all the entities that have 'cardinality' different number of
	 * values
	 ...
	 * @return
	 */
	// public static IntSet getEntitiesWithCardinality(KB kb, int relation, int
	// cardinality) {
